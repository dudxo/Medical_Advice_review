...
import style from '../css/Joinpage.module.css'
...
export default function Joinpage(){
    ...
    const [userAddress, setUserAddress] = useState('seoul')
    ...
    const [cpAddress, setCpAddress] = useState('cheonan') //회사 주소
    ...
    return(
            ...
            <div className = {style.tb}>
                <table>
                    ...
                    <tr>
                        ...
                        <td colSpan="3">
                            <div className={style.id}>   
                                <input type="text" name="id" className={style.input_id} onChange={input_id}/>
                                <button type="button" onClick={btn_progrm_idConfirm} className={style.btt_id}>아이디 중복확인</button>                               
                            </div>                          
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="eamil" onChange={input_email}/>
                        </td>
                    </tr>
                    ...
                    <tr className ={style.zipcode_tb}>
                        ...
                        <td colSpan="4">
                            <div className = {style.zipcode}>
                                ...
                                <button type="button" onClick={()=>alert('우편번호')} className={style.zipcode}>우편번호</button>
                                <br/>
        ...
        <div className={style.complete}>
            <button type = "button" onClick={btn_progrm_signup} disabled={!infoEmpty} className={style.btt_complete}>회원 가입 완료</button>
        </div>
        </div>
    )
}